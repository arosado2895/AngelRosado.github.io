...
$qrCodeUrl = $Authenticator->getQR('COMP 4400 LOCK', $_SESSION['auth_secret']);
...
<head>
    ...
    <meta name="description" content="Authenticator COMP 4400"/>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3"  style="background: white; padding: 20px; box-shadow: 10px 10px 5px #888888; margin-top: 100px;">
                ...
                <p style="font-style: italic;">Please Download Google Authenticator App</p>
                <hr>
