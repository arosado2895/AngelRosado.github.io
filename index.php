...
<body>
	<div class="container">
		...
		<div class="col-md-4 col-md-offset-4">
			<div class="text-center"><a href="787-233-9240"><img src="securelock.png"></a></div><br>
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="pull-left">
						Copyright &copy; 2019 <a href="#">Locky COMP 4410</a>
					</div>
			...
			if(submit == true){
				...
				$.post('index.php',$(this).serialize(),function(data){
					if(data.error == 1){
						...
						window.location = 'Authenticator index.php';
					}
				},"JSON").error(function(){
